...
RSpec.describe VotesController, type: :controller do
	...
	let(:other_user) { User.create!(name: Faker::Name.name, email: Faker::Internet.unique.email, password: "helloworld", role: :member) }
	let(:my_topic) { Topic.create!(name:  Faker::Name.name, description: Faker::Lorem.paragraph) }
	let(:user_post) { my_topic.posts.create!(title: Faker::Lorem.paragraph, body: Faker::Lorem.paragraph, user: other_user) }
